    ...
    <header className="fixed top-0 left-0 w-full z-50 backdrop-blur-md bg-gradient-to-r from-gray-900 via-black to-gray-900/90 text-violet-100 shadow-xl">
        ...
        <nav className="hidden md:flex">
          <ul className="flex space-x-8 text-base font-semibold">
            <li>
              <Link
                href="/about"
                className="hover:text-rose-300 transition duration-300 hover:underline underline-offset-4"
              >
                Обо мне
              </Link>
            </li>
      ...
      {isOpen && (
        <div className="md:hidden px-6 pb-6">
          <ul className="flex flex-col space-y-4 text-base font-medium bg-gray-900/90 rounded-xl shadow-md p-4">
            <li>
              <Link
                href="/about"
                onClick={() => setIsOpen(false)}
                className="block text-violet-100 hover:text-rose-300 transition duration-300"
              >
                Обо мне
              </Link>
            </li>
